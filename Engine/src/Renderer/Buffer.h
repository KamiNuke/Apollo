...
namespace Apollo
{
    ...
    public:
        ...
        [[nodiscard]] std::vector<BufferElement>::const_reverse_iterator rbegin() const { return m_elements.rbegin(); }
        [[nodiscard]] std::vector<BufferElement>::const_reverse_iterator rend() const { return m_elements.rend(); }
    private:
